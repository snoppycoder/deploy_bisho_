      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+$1,000.00 from last month</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Loan applications and disbursements over time</CardDescription>
              </CardHeader>
        ...
        <TabsContent value="loans" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monthly loan repayments over time</CardDescription>
            </CardHeader>
            <CardContent className="px-2">
              <AreaChart
                data={[
