...
// async function createJournalEntry(apiKey: string, transactionDetails: any) {
// 	try {
// 		const sessionId = await getSessionId(); // Get the session ID dynamically
// 		// Define account mapping for easy reference
// 		const accounts = {
// 			// Asset Cash Accounts
// 			cash: {
// 				id: 102,
...
// 		// Define journal entry parameters
// 		let debit = [];
// 		let credit = [];

// 		// Determine transaction type and handle accordingly
// 		switch (transactionDetails.type) {
// 			case "SAVINGS": // For savings or deposit
// 				debit.push([
// 					0,
// 					0,
// 					{
...
// 			case "WILLING_DEPOSIT": // For savings or deposit
// 				debit.push([
// 					0,
// 					0,
// 					{
...
// 			case "LOAN_DISBURSEMENT": // For loan disbursement
// 				debit.push([
// 					0,
// 					0,
// 					{
...
// 					0,
// 					{
// 						account_id: accounts.commercialLoan.id,
// 						name: "Commercial Loan",
// 						debit: 0,
// 						credit: transactionDetails.amount,
// 					},
...
// 			case "LOAN_REPAYMENT": // For loan repayment
// 				debit.push([
// 					0,
// 					0,
// 					{
...
// 			case "WITHDRAWAL": // For cash withdrawal
// 				debit.push([
// 					0,
// 					0,
// 					{
...
// 			case "INTEREST_INCOME": // For interest income
// 				debit.push([
// 					0,
// 					0,
// 					{
...
// 			case "INTEREST_EXPENSE": // For interest expense
// 				debit.push([
// 					0,
// 					0,
// 					{
...
// 		// Create the journal entry payload
...
// 				model: "account.move",
// 				method: "create",
// 				fields: ["move_type", "journal_id", "ref", "date", "line_ids"],
// 				values: {
// 					move_type: "entry",
// 					journal_id: 3,
// 					date: transactionDetails.date,
// 					ref: transactionDetails.reference,
// 					line_ids: [...debit, ...credit],
// 				},
// 			},
// 		};

// 		// Send the request to create the journal entry
...
// 			console.error("Error creating journal entry:", errorText);
// 			throw new Error("Failed to create journal entry");
// 		}

// 		// Parse and log response
// 		const jsonResponse = await response.json();
// 		console.log("Journal Entry Created:", jsonResponse);
// 	} catch (error) {
// 		console.error("Error in createJournalEntry:", error.message);
// 		throw error;
// 	}
