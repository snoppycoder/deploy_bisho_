...
import { BarChart3, CreditCard, FileText, Home, LogOut, Menu, PieChart, Settings, Users, X } from "lucide-react"
...
export function DashboardShell({ children }: DashboardShellProps) {
  ...
  const navItems = [
    {
      ...
      href: "/dashboard",
      icon: Home,
      roles: [UserRole.LOAN_OFFICER, UserRole.BRANCH_MANAGER, UserRole.REGIONAL_MANAGER, UserRole.FINANCE_ADMIN],
    },
    {
      title: "Members",
    ...
    },
    {
      ...
      icon: PieChart,
      roles: [UserRole.BRANCH_MANAGER, UserRole.REGIONAL_MANAGER, UserRole.FINANCE_ADMIN],
    },
    {
      title: "Settings",
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-100">
      ...
      {isOpen && <div className="fixed inset-0 z-40 bg-black/50 md:hidden" onClick={closeSidebar}></div>}
